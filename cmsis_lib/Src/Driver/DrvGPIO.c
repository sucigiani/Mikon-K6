...
//*****************************************************************************
//
//! \brief ISR to handle GPIO A and GPIO B interrupt event 
//!
//! \param None 
//!
//! \return None  
...
//*****************************************************************************
//
//! \brief ISR to handle GPIO C,D,E interrupt event 
//!
//! \param None 
//!
//! \return None  
...
//*****************************************************************************
//
//! \brief ISR to handle External INT0 interrupt event 
//!
//! \param None 
//!
//! \return None  
...
//*****************************************************************************
//
//! \brief ISR to handle External INT1 interrupt event 
//!
//! \param None 
//!
//! \return None  
...
//!
//! \param port  E_DRVGPIO_PORT, specify GPIO port. It could be E_GPA, E_GPB,
//!  E_GPC, E_GPD.and E_GPE.
//! \param i32Bit  Specify pin of the GPIO port. It could be 0~15.
//! \param mode  E_DRVGPIO_IO, set the specified GPIO pin to be E_IO_INPUT,
//!  E_IO_OUTPUT, E_IO_OPENDRAIN or E_IO_QUASI mode.
//!
//! \return E_SUCCESS Operation successful E_DRVGPIO_ARGUMENT Incorrect argument
//!  
//
//*****************************************************************************
...
//! \param i32Bit  Specify pin of the GPIO port. It could be 0~15.
//!
//! \return The specified input pin value 0 / 1 E_DRVGPIO_ARGUMENT Incorrect
//!  argument 
//
//*****************************************************************************
...
//! \param port  E_DRVGPIO_PORT, specify GPIO port. It could be E_GPA, E_GPB,
//!  E_GPC, E_GPD and E_GPE
//! \param i32Data  The data output value. It could be 0~0xFFFF
//!
//! \return E_SUCCESS Operation successful 
//!         E_DRVGPIO_ARGUMENT Incorrect argument
//!  
...
//!  E_GPC, E_GPD and E_GPE
//!
//! \return    The specified input port value             0 ~ 0xFFFF
//!            E_DRVGPIO_ARGUMENT Incorrect argument 
//
//*****************************************************************************
...
//!  E_GPC, E_GPD and E_GPE.
//!
//! \return     The portt value of the specified register 0 ~ 0xFFFF
//!             E_DRVGPIO_ARGUMENT Incorrect argument 
//
//*****************************************************************************
...
//! \param port  E_DRVGPIO_PORT, specify GPIO port. It could be E_GPA, E_GPB,
//!  E_GPC, E_GPD and E_GPE.
//! \param i32MaskData  Specify pins of the GPIO port. It could be 0~0xFFFF.
//!
//! \return E_SUCCESS  E_DRVGPIO_ARGUMENT 
//!  
//
//*****************************************************************************
...
//*****************************************************************************
//
//! \brief This function is used to remove the write protect function of the 
...
//!  DBCLKSRC_10K
//!
//! \note If the debounce clock source is from internal 10 KHz
...
//*****************************************************************************
//
//! \brief Enable the interrupt function of the specified GPIO pin. Excpet for
//!  GPB.14 and GPB.15 pins are for external interrupt used. 
//!
//! \param port  E_DRVGPIO_PORT, specify GPIO port. It could be E_GPA, E_GPB,
//!  E_GPC and E_GPD.
//! \param i32Bit  Specify pin of the GPIO port. It could be 0~15. But the
//!  GPB.14 and 15 are only used for external interrupt 0/1.
//! \param TriggerType  E_DRVGPIO_INT_TYPE, specify the interrupt trigger type.
//!  It could be E_IO_RISING, E_IO_FALLING or E_IO_BOTH_EDGE and it's meaning
//!  the interrupt function enable by rising egde/high level, falling edge/low
//!  level or both riging edge and falling egde. If the interrupt mode is
//!  E_MODE_LEVEL and interrupt type is E_BOTH_EDGE¡Athen calling this API is
//!  ignored.
...
//*****************************************************************************
//
//! \brief Disable the interrupt function of the specified GPIO pin. Excpet for
//!  GPB.14 and GPB.15 pins are for external interrupt used. 
//!
//! \param port  E_DRVGPIO_PORT, specify GPIO port. It could be E_GPA, E_GPB,
//!  E_GPC and E_GPD.
...
//*****************************************************************************
//
//! \brief Install the interrupt callback function for GPA/GPB port and
//!  GPC/GPD/GPE port. 
//!
//! \param pfGPABCallback , the function pointer of GPA/GPB callback function.
//! \param pfGPCDCallback , the function pointer of GPC/GPD/GPE callback
//!  function.
//!
//! \return None 
//
...
//!  by level trigger. If the interrupt mode is E_MODE_LEVEL and interrupt type
//!  is E_BOTH_EDGE¡Athen calling this API is ignored.
//! \param pfEINT0Callback  It's the function pointer of the external INT0
//!  callback function.
//!
//! \return None 
//
...
//*****************************************************************************
//
//! \brief Disable the interrupt function for external GPIO interrupt from
//!  /INT0(GPB.14) pin. 
//!
//! \param None 
//!
...
//!  E_GPC, E_GPD and E_GPE.
//!
//!\note If the corresponding bit of the return port value is 1,
