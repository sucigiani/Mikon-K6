...
//!
//! \param InputMode:Specify the operation mode.It might be single, burst, single 
//!  cycle scan or continuous scan mode.(ADC_SINGLE_OP / ADC_BURST_OP /
//!  ADC_SINGLE_CYCLE_OP / ADC_CONTINUOUS_OP)
//! \param u8ChannelSelBitwise: Specify the input channels. 
...
//!     3 and 4 are enabled.
//! \param  Specify the clock source of ADC clock,It could be EXTERNAL_12MHZ / 
//!  INTERNAL_PLL / INTERNAL_HCLK / INTERNAL_RC22MHZ.
//! \param Determine the ADC clock frequency. It could be 0~255.ADC clock frequency 
//!  = ADC clock source frequency / ( u8AdcDivisor + 1 )
//!
//! \return None  
//
//*****************************************************************************
...
//!
//! \param Specify the analog input source.It could be EXTERNAL_INPUT_SIGNAL,                                                       */
//!  INTERNAL_BANDGAP and INTERNAL_TEMPERATURE_SENSOR.      
//!
//! \return None  
//
//*****************************************************************************
...
//*****************************************************************************
//
//! \briefEnable the ADC compare 0 interrupt and setup callback function.
//!
...
//!  complete an A/D conversion.In NUC1x0xxxCx with HCLK clock source,it needs
//!  23 ADC clocks to complete an A/D conversion.
//!
//! \param  None   
//!
...
//*****************************************************************************
//
//! \brief Allow the external trigger pin STADC (PB8) to be the trigger source                        
//!  of ADC.Software must configure the external trigger pin as an input pin in 
//!  advance.The trigger condition could be low-level/high-level/falling-edge/
//!  positive-edge.TRGE bit and ADST bit should be clear to 0 before changing 
//!  TRGS bit.                           
//!
...
//!
//! \return The 32 bits conversion result. It is generated by extending the 
//!  original 12 bits conversion result.  
//
//*****************************************************************************
...
//*****************************************************************************
//
//! \brief Enable the PDMA data transfer function.When PDMA transfer is enabled,
//!  the ADIE bit must be set to '0'.
//!
//! \param  None   
//!
//! \return None  
...
//*****************************************************************************
//
//! \brief Disable the PDMA data transfer function.
//!
//! \param  None   
//!
//! \return None  
...
//!   CmpCondition   Specify the compare condition.
...
//*****************************************************************************
//
//! \brief Select the output format of differential input mode.
//!
//! \param OutputFormat   Specify the output format.       
...
//*****************************************************************************
//
//! \brief Get the version number of NUC100 ADC driver.
//!
//! \param None   
//!
